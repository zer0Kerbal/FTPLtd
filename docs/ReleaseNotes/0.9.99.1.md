...
tags: FTPLtd,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
[![FTP Limited (FTPL) Version][shd:stat]][forum]  
...
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/FTPLtd/files">CurseForge</a></p></div>

## Summary

* In anticipation of FTPIS and FTPXL
  * Add
    * textures, models, and common config files from FTP
    * multiple FTP parts addons using one set of models and textures
* fix
  * texture related issues reported in KSP.log
  * agent related issues reported in KSP.log
...
[forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/209628-*/ "FTP Ltd forum thread"
[issue]: https://github.com/zer0Kerbal/FTPLtd/issues/ "Issue Tracker"
[pages]: https://zer0kerbal.github.io/FTPLtd/ "GitHub Pages"

<!-- shields -->
[shd:stat]: https://img.shields.io/badge/FTP%20Ltd%20(FTPL)%20-v0.9.99.1--prerelease-BADA55.svg?style=plastic&labelColor=darkgreen/ "0.9.99.1-prerelease"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/FTPLtd/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?style=plastic&labelColor=black "AVC Valid"
