...
# [FTP Limited (FTPL)][CURSFG:url]

[![FTP Limited (FTPL)][SHD:mod]][CURSFG:url]  
[![KSP version][KSP:shd]][KSP:url] [![License][LIC:shd]][LIC:url]  
[![Curseforge][CURSFG:shd]][CURSFG:url] [![GitHub][GITHUB:shd]][GITHUB:url] [![Pages][SHD:pgs]][pages]

Agent, flags, models, textures, and common files used in all [Fuel Tanks Plus][CURSFG:url] add-ons for Kerbal Space Program.

## By [`zer0Kerbal`][zedK], inspired by, and with content licensed from [`NecroBones`][necrobones]
...
[LIC:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/FTPLtd/master/json/license.json "CC BY-SA 4.0+ARR"
